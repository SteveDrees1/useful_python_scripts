...
# The below four lines bring out the value of currency from the api at
# fixer.io.I had to register there, the key is unique to me.
url = "https://data.fixer.io/api/latest?access_key=33ec7c73f8a4eb6b9b5b5f95118b2275"
...
currencies = [
    ...
    "ANG : Dutch Guilder,Netherlands Antilles Guilder, Bonaire, Cura &  # 231;ao,Saba,Sint Eustatius,Sint Maarten",
    "AOA : Angolan Kwanza,Angola Kwanza",
    "ARS : Argentine Peso,Argentina Peso,Islas Malvinas",
    "AUD : Australian Dollar,Australia Dollar,Christmas Island,Cocos (Keeling) Islands, Norfolk Island, Ashmore and "
    "Cartier Islands, Australian Antarctic Territory, Coral Sea Islands, Heard Island, McDonald Islands, Kiribati, "
    "Nauru",
    ...
    "CHF : Swiss Franc,Switzerland Franc,Liechtenstein,Campione d &  # 039;Italia,B&#252;singen am Hochrhein",
    ...
    "EUR : Euro,Euro Member Countries,Andorra,Austria,Azores,Baleares (Balearic Islands), Belgium, Canary Islands, "
    "Cyprus, Finland, France, French Guiana, French Southern Territories, Germany, Greece, Guadeloupe, "
    "Holland (Netherlands), Holy See(Vatican City), Ireland (Eire), Italy, Luxembourg, Madeira Islands, Malta, "
    "Monaco, Montenegro, Netherlands",
    "FJD : Fijian Dollar,Fiji Dollar",
    "FKP : Falkland Island Pound,Falkland Islands (Malvinas) Pound",
    "GBP : British Pound,United Kingdom Pound,United Kingdom (UK), England, Northern Ireland, Scotland, Wales,"
    "Falkland Islands, Gibraltar, Guernsey, Isle of Man, Jersey, Saint Helena and Ascension, South Georgia and the "
    "South Sandwich Islands, Tristan da Cunha",
    ...
    "Territory, British Virgin Islands, Ecuador, El Salvador, Guam, Haiti, Micronesia, Northern Mariana Islands, "
    "Palau, Panama, Puerto Rico, Turks and Caicos Islands, United States Minor Outlying Islands, Wake Island, "
    "East Timor",
    ...
    "XAF : Central African CFA Franc BEAC,Communaut&#233; Financi&#232;re Africaine(BEAC) CFA Franc BEACH, Cameroon, "
    "Central African Republic, Chad, Congo / Brazzaville, Equatorial Guinea, Gabon",
    "XAG : Silver Ounce,Silver",
    "XAU : Gold Ounce,Gold",
    "XCD : East Caribbean Dollar,East Caribbean Dollar,Anguilla,Antigua and Barbuda, Dominica, Grenada, "
    "The Grenadines and Saint Vincent, Montserrat",
    "XDR : IMF Special Drawing Rights,International Monetary Fund (IMF) Special Drawing Rights",
    "XOF : CFA Franc,Communal&#233; Financi&#232;re Africaine (BCEAO) Franc, Benin, Burkina Faso, Ivory Coast,"
